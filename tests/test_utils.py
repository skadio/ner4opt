...
class UtilsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._unnormalized_text = "  This\nis\r\na\nstring\n\rwith\n\rmultiple\n\r\nnewlines\n\n\rand   spaces.  "
        self._normalized_text = "This is a string with multiple newlines and spaces."

    def test_preprocess(self):
        self.assertEqual(preprocess(self._unnormalized_text), self._normalized_text)
